 ...
 * @author Rajail Islam
 */
public class DataRetrieveService_1 {
   ...
   static Connection conn = MySqlDbConnection.getConnection();
    ...
    public static List<Student> getStudentList() {
        ...
        try {
            ...
            Logger.getLogger(DataRetrieveService_1.class.getName()).log(Level.SEVERE, null, ex);
        }
        return list;
    }
    public static void main(String[] args) {
          List<Student> list = DataRetrieveService_1.getStudentList();
